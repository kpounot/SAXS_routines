...
sys.path.insert(0, os.path.abspath('../../saxs_routines/data_analysis'))
...
project = 'SAXS_routines'
copyright = '2021, Kevin Pounot'
author = 'Kevin Pounot'

# The full version, including alpha/beta/rc tags
version = release = saxs_routines.__version__
